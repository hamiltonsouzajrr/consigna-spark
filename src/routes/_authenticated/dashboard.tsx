      ...
      <div className="card-premium mb-8 p-6 text-white md:p-8">
        ...
        <div className="mt-6 border-t border-white/25 pt-4">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            ...
            <Button onClick={processarManual} disabled={running || !manualCpf} className="bg-white font-bold text-blue-900 shadow-md hover:bg-white/90 disabled:opacity-60">
        ...
        {debugRow && (() => {
          ...
          return (
            <div className="result-panel mt-6 rounded-lg border bg-card p-4 text-sm text-foreground shadow-lg">
