...
- Manter a busca interna ampla
- Mostrar margens reais editáveis apenas da carteira da consultora responsável; administradores e outras consultoras poderão visualizar conforme o acesso atual.
...
- Validar margens reais versus estimativas, endereços, ranking de telefones sempre do mais acertivo para o menos acertivo considerando a ordem das planilhas 1,2,3,4 telefone ou número, Ligar/WhatsApp, histórico e pontos.
