# Aba "Quitação - Cartão de crédito " — prospecção de compra de dívida (AL)

Será possível administrar excluir ou inserir diretamente as planilhas para essa aba do menu lateral 
