...
2. **Clientes repetidos, só irão permanecer os duplicado e preservarei os que possuem as informações das margens** : 11.310 leads têm o mesmo CPF em mais de um lote (5.474 CPFs). O Anndrey da sua tela existe duas vezes: numa cópia a margem é R$ 218,27 e na outra não há margem nem município preenchidos. Quem abre um dos dois vê informação incompleta.
