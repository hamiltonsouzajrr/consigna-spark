...
Inclusive Deixando todos convertidos dessa semana em standby
...
- Em vez de "+25 pontos", ela vê: "Venda registrada. Aguardando conferência do gerente(peça a verificação, pois só irá compultar Apois ele confirmar sua venda)."
